...
time = []
for key in value:
	p1.append(value[key]["P1"])
	p2.append(value[key]["P2"])
	p3.append(value[key]["P3"])
	p4.append(value[key]["P4"])

	i1.append(value[key]["I1"])
	i2.append(value[key]["I2"])
	i3.append(value[key]["I3"])
	i4.append(value[key]["I4"])

	time.append(value[key]["time"])
